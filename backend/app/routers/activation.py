...
def status_payload():
    return ActivationStatus(state=activation_manager.state, wake_listening=activation_manager.wake_listening, clap_listening=activation_manager.clap_listening, last_event=activation_manager.last_event, warning=activation_manager.warning)

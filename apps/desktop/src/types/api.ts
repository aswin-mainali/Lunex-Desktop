...
export type CommandResponse = { command: string; intent: string; safety_level: string; status: string; response: string; requires_confirmation: boolean; activation_state: string; task?: Task | null; source?: string; mocked?: boolean };
